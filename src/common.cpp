...
std::string get_executable_path(const char *argv0) {
    ...
    // Haiku has its own API for retrieving the path to the executable of the current process.
    if (find_path(B_APP_IMAGE_SYMBOL, B_FIND_PATH_IMAGE_PATH, nullptr, buff, sizeof buff) == B_OK) {
